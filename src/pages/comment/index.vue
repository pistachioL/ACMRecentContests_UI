          ...
          <el-button type="text,success" @click="jump" round>发帖</el-button>
            <ul>
              <li v-for="item in list" :key='item' style="list-style: none" >
                  ...
                  <!-- 姓名 -->
                  <div v-bind:style="{ color: activeColor, size:fontSize + 'px', } ">&#12288&#12288&#12288&#12288{{item[2]}}&#12288&#12288&#12288&#12288&#12288&#12288&#12288&#12288&#12288&#12288&#12288&#12288&#12288&#12288&#12288&#12288&#12288
                      <!-- 日期 -->
